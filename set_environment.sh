...
alias PREPAREMCGENERATION2017="cp $PPSFRAMEWORKROOT/MCProduction/Execution/2017/* $WORKINGPPSDIR2017/." 
alias PREPAREMCGENERATION2018="cp $PPSFRAMEWORKROOT/MCProduction/Execution/2018/* $WORKINGPPSDIR2018/." 
