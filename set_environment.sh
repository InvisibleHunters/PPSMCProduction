...
alias PREPAREMCGENERATION2017="cp $PPSFRAMEWORKROOT/MCProduction/Execution/2017/*.sh $WORKINGPPSDIR2017/.; cp $PPSFRAMEWORKROOT/MCProduction/Execution/2017/*.py $WORKINGPPSDIR2017/." 
alias PREPAREMCGENERATION2018="cp $PPSFRAMEWORKROOT/MCProduction/Execution/2018/*.sh $WORKINGPPSDIR2018/.; cp $PPSFRAMEWORKROOT/MCProduction/Execution/2018/*-py $WORKINGPPSDIR2018/." 
