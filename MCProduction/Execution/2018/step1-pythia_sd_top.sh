...
#curl -s -k https://raw.githubusercontent.com/dfigueiredo/PPSMCProduction/master/MCProduction/Configuration/PYTHIA8_SingleDiffractiveTop_13TeV_pt60_cff.py --retry 3 --create-dirs -o Configuration/GenProduction/python/pythia8-singlediffraction-top-fragment.py
curl -s -k https://raw.githubusercontent.com/dfigueiredo/PPSMCProduction/master/MCProduction/Configuration/PYTHIA8_SingleDiffractiveTop_13TeV_pt80_cff.py --retry 3 --create-dirs -o Configuration/GenProduction/python/pythia8-singlediffraction-top-fragment.py
